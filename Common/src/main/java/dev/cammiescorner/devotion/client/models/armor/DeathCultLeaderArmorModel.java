...
public class DeathCultLeaderArmorModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightCloakSleeve = cloak.addOrReplaceChild("rightCloakSleeve", CubeListBuilder.create().texOffs(46, 81).addBox(2f, 3f, -6f, 9f, 12f, 8f, new CubeDeformation(0.25f)), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, -0.0436f, 0f));
		PartDefinition cube_r6 = rightCloakSleeve.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 64).addBox(1f, -2f, -7f, 11f, 7f, 10f, new CubeDeformation(0.4f)), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, -0.0436f, -0.1618f));
		PartDefinition leftCloakSleeve = cloak.addOrReplaceChild("leftCloakSleeve", CubeListBuilder.create().texOffs(80, 73).addBox(-11f, 3f, -6f, 9f, 12f, 8f, new CubeDeformation(0.25f)), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, 0.0436f, 0f));
		PartDefinition cube_r8 = leftCloakSleeve.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(46, 64).addBox(-12f, -2f, -7f, 11f, 7f, 10f, new CubeDeformation(0.4f)), PartPose.offsetAndRotation(0f, 0f, 0f, 0f, 0.0436f, 0.1618f));
